...
while opcion != 5:
    ...
    if opcion == 1:  # listar clientes
        ...
        cliente_insert = Cliente(nombre=cliente_nombre, 
        ...
        cliente_update = Cliente(id_cliente=cliente_id, nombre=cliente_nombre, 
                                 apellido=cliente_apellido, edad=cliente_edad, telefono=cliente_tel)
